...
import { TreeNode } from './Structures/Nodes.js';
import { BinarySearchTree } from "./Structures/DataStructures.js";

// A list of constants of that our Binary Search tree uses
...
const NODEDISTANCE = new THREE.Vector3 (12 , 6.5 , 0);
...
function main ()
{
    ...
    const myBinarySearchTree = new BinarySearchTree (STARTINGPOINT , NODEDISTANCE , lineColorMaterial);
    myBinarySearchTree.AddToScene (scene);


    elOutput.innerHTML = "Binary Search Tree Initialized";
    ...
    function Insert ()
    {
        ...
        fontLoader.load( TEXTFONTPATH , function ( font ) {
            ...
            myBinarySearchTree.Insert (new TreeNode (textGeometry , nodeColorMaterial , value));
    ...
    function Delete ()
    {
        ...
        if (myBinarySearchTree.IsEmpty())
        {
            GenerateOutput ("Binary Search Tree is Empty");
            return;
        }

        

        if (myBinarySearchTree.Delete (value))
        {
